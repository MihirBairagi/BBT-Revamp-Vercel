      ...
      <div className="max-1920 overflow-hidden">
        ...
        >
          ...
          <div className="relative mt-[2.5rem] mb-[4rem] lg:mt-[4rem] xl:mt-[6.5rem] xl:mb-[8.5rem] 1xl:mt-[8rem] 2xl:mb-[9.5rem] 3xl:mb-[12rem]">
            {/* Mobile Video */}
            <video
              src="/videos/showroom-banner-video.mp4"
          ...
          <div className="sm:max-w-[362px] sm:mx-auto lg:mt-[4rem] lg:max-w-[25rem] 1xl:max-w-[27rem] 3xl:max-w-[36.2rem]">
            <button
              onClick={() => setOpenPopup(true)}
              className="flex justify-center items-center w-full h-[5.6rem] bg-black border border-black text-white p-[1rem] rounded-[4rem] lg:h-[4.6rem] transition-all duration-500 ease-in-out hover:bg-white hover:text-black 1xl:h-[4.8rem] 3xl:h-[6.57rem] 3xl:rounded-[6rem] group"
            >
              <img
