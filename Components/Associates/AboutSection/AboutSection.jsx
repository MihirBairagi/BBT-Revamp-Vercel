    ...
    <section className="bg-black">
      <div className="max-w-[3000px] mx-auto relative">
        <div className="sm:hidden">
          <img
            src="/images/associates/about-bg-desktop.webp"
        ...
        <div className="absolute top-0 left-0 w-full h-full bg-[rgba(0,0,0,0.3)]">
          <div className="container w-full h-full">
            <div
              className="flex h-full w-full flex-col  sm:bg-transparent justify-between py-[6rem] sm:justify-start sm:max-w-[60%] lg:pt-[8rem] xl:max-w-[43%] xl:pt-[12rem] 2xl:pt-[14rem] 3xl:pt-[22rem] 3xl:max-w-[44%]"
              data-aos="fade-up"
            ...
            >
              <div className="text-center text-white lg:max-w-[440px] xl:max-w-[470px] 3xl:max-w-[610px] sm:text-left">
                ...
                <h2 className="font-light [&>b]:font-normal leading-[1.2] mt-[1.5rem] tracking-[-2px] text-[2.9rem] xl:text-[3.75rem] 1xl:text-[4.2rem] 1xl:mt-[2rem] 2xl:text-[4.3rem] 3xl:text-[5.8rem] 3xl:tracking-[-3px] capitalize">
                  know more about <b>Big Boy Toyz and legacy</b>
                </h2>
