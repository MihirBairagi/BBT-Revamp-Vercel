          ...
          <div className="text-center">
            <div className="hidden md:block text-center mb-[2rem] lg:mb-[1.7rem]">
              <p className="flex flex-wrap justify-center items-center font-light">
                <Link
                  href="/"
                  className="text-[1.2rem] 2xl:text-[1.3rem] 3xl:text-[1.5rem] hover:text-gray-600 transition-colors duration-300"
                >
                  Home
                </Link>
                <img
            ...
            {totalBlogs > 0 && (
              <div className="mt-[2rem] md:mt-[3rem]">
                <p className="text-[1rem] md:text-[1.2rem] lg:text-[1.3rem] xl:text-[1.4rem] text-gray-600 font-light">
                  Explore {totalBlogs.toLocaleString()} insightful articles about luxury cars, automotive trends, and industry expertise
                </p>
              </div>
            )}
          </div>
