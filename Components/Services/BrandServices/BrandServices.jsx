...
const services = [
  {
    ...
    image: "/images/services/service-img-1.webp",
  },
  {
    title: "Audi Car Detailing",
    description:
      "With Service Inclusive, you have complete peace of mind for a period of  your choice. During this time, you don’t have to waste a moment thinking.",
    image: "/images/services/service-img-2.webp",
  },
  {
    title: "Jaguar Car Detailing",
    description:
      "With Service Inclusive, you have complete peace of mind for a period of  your choice. During this time, you don’t have to waste a moment thinking.",
    image: "/images/services/service-img-3.webp",
  },
  {
    title: "Mercedes Car Service",
    description:
      "With Service Inclusive, you have complete peace of mind for a period of  your choice. During this time, you don’t have to waste a moment thinking.",
    image: "/images/services/service-img-4.webp",
  },
  {
    title: "Ferrari Car Detailing",
    description:
      "With Service Inclusive, you have complete peace of mind for a period of  your choice. During this time, you don’t have to waste a moment thinking.",
    image: "/images/services/service-img-5.webp",
  },
];
    ...
    <section className="bg-white py-[6rem] lg:py-[8rem] xl:py-[12rem] 1xl:py-[14rem] 3xl:py-[18rem]">
      <div className="max-1920">
        <div className="container">
          <div>
            <h2 className="font-light leading-[1.2] tracking-tighter mt-[1rem] text-center lg:text-left xl:text-[3.9rem] xl:leading-[1.2] xl:tracking-[-1.8px] 1xl:text-[4.5rem] 1xl:tracking-[-3px] 1xl:leading-[1.2] 2xl:text-[4.6rem] 3xl:text-[5.8rem] 3xl:leading-[1.1] capitalize [&>br]:hidden md:[&>br]:block">
              We are top 3 best luxury car{" "}
              <b>
                Services <br /> company in India
              </b>
            </h2>
            <p className="text-[1.5rem] text-[#313131] text-center lg:text-left xl:text-[1.9rem] 1xl:text-[2.1rem] 2xl:text-[2.3rem] 3xl:text-[2.8rem] mt-[2.5rem] font-light [&>br]:hidden md:[&>br]:block">
              Our list of Associates share a common vision for Automotive <br />{" "}
              Excellence and a deep passion for Exotic cars.
            </p>
          </div>
          <ul className="border-t border-[#B2B2B2] mt-[5rem] xl:mt-[8rem] 1xl:mt-[10rem]">
