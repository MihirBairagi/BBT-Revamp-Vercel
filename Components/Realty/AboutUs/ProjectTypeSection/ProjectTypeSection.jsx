                ...
                <ul className='lg:w-[65%] mt-[2.5rem] flex overflow-x-scroll w-[100vw] -mx-[20px] px-[2rem] gap-[3rem] no-scrollbar lg:gap-[1.5rem] lg:mx-[0] lg:px-[0] lg:mt-[0]' >
                     <li className='bg-[#fff] p-[2rem] rounded-[2rem] min-w-[75vw] lg:min-w-[31%] lg:p-[1rem] lg:rounded-[1rem] lg:pb-[2rem] 3xl:p-[2rem] 3xl:pb-[3rem] 3xl:rounded-[2rem]' >
                        <a target="_blank" href="https://www.bigboytoyz.com/" >
                            <div className="img-outer relative ">
                                <div className="img-box lg:max-h-[205px] 1xl:max-h-[265px] 2xl:max-h-[285px] 3xl:max-h-[340px]  lg:rounded-[1rem] overflow-hidden">
                                    <img className='rounded-[2rem] w-full lg:rounded-[1rem]' src="/realty/images/a-pro-slide-2.webp" alt="" />
                                </div>
                                <img className=' absolute bottom-[2rem] right-[2rem] w-[15rem] lg:w-[8rem] lg:bottom-[1.2rem] lg:right-[1.2rem] 3xl:w-[13rem] 3xl:right-[2rem] 3xl:bottom-[2rem]' src="/realty/images/a-pro-logo-2.webp" alt="" />
                            </div>
                    ...
                    <li className='bg-[#fff] p-[2rem] rounded-[2rem] min-w-[75vw] lg:min-w-[31%] lg:p-[1rem] lg:rounded-[1rem] lg:pb-[2rem] 3xl:p-[2rem] 3xl:pb-[3rem] 3xl:rounded-[2rem]' >
                        <a target="_blank" href="https://cars.co.in/" >
                            <div className="img-outer relative ">
                                <div className="img-box lg:max-h-[205px] 1xl:max-h-[265px] 2xl:max-h-[285px] 3xl:max-h-[340px]  lg:rounded-[1rem] overflow-hidden">
                                    <img className='rounded-[2rem] w-full lg:rounded-[1rem]' src="/realty/images/a-pro-slide-1.webp" alt="" />
                                </div>
                                <img className=' absolute bottom-[2rem] right-[2rem] w-[15rem] lg:w-[8rem] lg:bottom-[1.2rem] lg:right-[1.2rem] 3xl:w-[13rem] 3xl:right-[2rem] 3xl:bottom-[2rem]' src="/realty/images/a-pro-logo-1.webp" alt="" />
                            </div>
                            <div className="mt-[2.5rem] lg:mt-[1.5rem]">
                     ...
                     <li className='bg-[#fff] p-[2rem] rounded-[2rem] min-w-[75vw] lg:min-w-[31%] lg:p-[1rem] lg:rounded-[1rem] lg:pb-[2rem] 3xl:p-[2rem] 3xl:pb-[3rem] 3xl:rounded-[2rem]' >
                        <a target="_blank" href="https://queensdriveclub.com/" >
                            <div className="img-outer relative ">
                                <div className="img-box lg:max-h-[205px] 1xl:max-h-[265px] 2xl:max-h-[285px] 3xl:max-h-[340px]  lg:rounded-[1rem] overflow-hidden">
                                    <img className='rounded-[2rem] w-full lg:rounded-[1rem]' src="/realty/images/a-pro-slide-3.webp" alt="" />
                                </div>
                                <img className=' absolute bottom-[2rem] right-[2rem] w-[15rem] lg:w-[8rem] lg:bottom-[1.2rem] lg:right-[1.2rem] 3xl:w-[13rem] 3xl:right-[2rem] 3xl:bottom-[2rem]' src="/realty/images/a-pro-logo-3.webp" alt="" />
                            </div>
                            <div className="mt-[2.5rem] lg:mt-[1.5rem]">
