            ...
            <ul className='mt-[3rem] flex flex-wrap justify-between lg:mt-0' >
              ...
              >
                <div className='mb-[2rem] 3xl:mb-[3rem]' >
                  <img className='w-full' src="/realty/images/c-office-1.webp" alt="" />
                </div>
                <div className="flex flex-wrap justify-between">
                  <div className="text w-full lg:w-[60%]">
                    ...
                    <div className='flex items-start mb-[1.5rem]' >
                        <img className='w-[1.5rem] mr-[1.5rem] object-contain 3xl:w-[1.7rem] 3xl:mt-[0.5rem]' src="/realty/images/c-office-loc.png" alt="" />
                    ...
                    <div className='flex items-start mb-[1.5rem]' >
                        <img className='w-[1.5rem] mr-[1.5rem] object-contain 3xl:w-[1.7rem] 3xl:mt-[0.5rem]' src="/realty/images/c-office-tel.png" alt="" />
                  ...
                  <div className="btn-box w-full lg:w-max mt-[1.5rem] lg:mt-[1rem]">
                    ...
                    href="/realty/pdf/PAVILION BY BBT BROSHURE FULL SIZE  .pdf">
                        <div className="flex w-max items-center">
                            <img className='w-[2rem] mr-[1.5rem] lg:mr-[1rem] lg:w-[1.5rem] 3xl:w-[2.5rem] 3xl:mr-[1.5rem]' src="/realty/images/c-office-pdf.png" alt="" />
                            <p className='max-[1023px]:text-[1.7rem] f-18' >Project Brochure</p>
                        </div>
                        <img className='w-[1.5rem] lg:w-[1rem] lg:ml-[1rem] 3xl:w-[1.5rem] 3xl:ml-[3rem]' src="/realty/images/c-office-down.png" alt="" />
                    </a>
                  </div>
                </div>
              </li>
              ...
              >
                <div className='mb-[2rem] 3xl:mb-[3rem] launching-soon-tag relative' >
                  <img className='w-full' src="/realty/images/c-office-2.webp" alt="" />
                </div>
                <div className="flex flex-wrap justify-between">
                  <div className="text w-full lg:w-[60%]">
              ...
              >
                <div className='mb-[2rem] 3xl:mb-[3rem] launching-soon-tag relative' >
                  <img className='w-full' src="/realty/images/c-office-4.webp" alt="" />
                </div>
                <div className="flex flex-wrap justify-between">
                  <div className="text w-full lg:w-[60%]">
              ...
              >
                <div className='mb-[2rem] 3xl:mb-[3rem] launching-soon-tag relative' >
                  <img className='w-full' src="/realty/images/c-office-3.webp" alt="" />
                </div>
                <div className="flex flex-wrap justify-between">
                  <div className="text w-full lg:w-[60%]">
