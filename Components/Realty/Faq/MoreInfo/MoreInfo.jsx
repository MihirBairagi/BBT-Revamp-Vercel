...
const contact = {
  url: "/contact",
  title: "Contact Us",
  thumbnail: "/realty/images/faq/info-bg-1.webp",
};
const careers = {
  url: "/careers",
  title: "Careers",
  thumbnail: "/realty/images/faq/info-bg-2.webp",
};
const Showrooms = {
  url: "/showrooms",
  title: "Showrooms",
  thumbnail: "/realty/images/faq/info-bg-3.webp",
};
  ...
  return (
    ...
    >
      <div>
        <img
          src={
            data?.thumbnail ? data.thumbnail : "/realty/images/bbt-world-item-1.webp"
          }
      ...
      <span className="w-14 h-14 rounded-50% bg-white flex items-center justify-center p-1 absolute top-[3rem] right-[3rem] md:top-12 md:right-12 xl:w-[4.3rem] xl:h-[4.3rem] 1xl:w-[5rem] 1xl:h-[5rem] 3xl:w-[6.7rem] 3xl:h-[6.7rem] 3xl:top-16 3xl:right-16 group-hover:bg-black transition-all duration-500 ease-in">
        <img
          src="/realty/images/showroom-location-arrow.webp"
