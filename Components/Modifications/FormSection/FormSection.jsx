...
const FormSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setSubmitting(true);
      await submitForm({
        formType: "modifications",
        data: { name, email, phone, vehicle, model },
      });
      setName("");
      setEmail("");
      setPhone("");
      ...
      <div className="max-1920">
        <div className="container">
          ...
          >
           ...
           Ready to Transform  <b>Your Ride?</b>
            </h2>
            <p className="text-[1.5rem] xl:text-[1.9rem] 1xl:text-[2.1rem] 3xl:text-[2.8rem] mt-[2.5rem] font-light [&>br]:hidden sm:[&>br]:block">
             Enter your car’s details and connect with our modification experts. <br /> Precision upgrades, crafted to perfection.
            </p>
          </div>
          <div
            className="xl:w-[90%] xl:mx-auto"
            data-aos="fade-up"
            data-aos-easing="linear"
            data-aos-duration="500"
          >
            <form
              action=""
              className="w-full block mt-[3rem] 3xl:mt-[5rem]"
            ...
            >
              ...
              <div className="mt-[2rem]">
                <button
                  ...
                  disabled={submitting}
                >
                  {submitting ? "Submitting..." : "Start My Build"}
                </button>
              </div>
            </form>
          </div>
