          ...
          <div className="container w-full h-full">
            <div className="flex h-full w-full flex-col justify-between py-[6rem] sm:justify-start xl:pt-[7rem] 1xl:pt-[8rem] 2xl:pt-[9rem] 3xl:pt-[12rem]">
              ...
              <div className="text-center sm:mt-[3rem] 3xl:mt-[5rem]">
                <Link
                  href="/showrooms"
                  className="w-full max-w-[31rem] btnWhite h-[5.5rem] flex justify-center items-center text-[1.4rem] px-[3rem] py-[1rem] rounded-[3rem] mx-auto tracking-[-1px] font-medium sm:max-w-[27.3rem] xl:h-[4.5rem] xl:max-w-[17rem] xl:text-[1.2rem] 1xl:h-[5rem] 1xl:max-w-[20rem] 1xl:text-[1.4rem] 2xl:max-w-none 2xl:w-max 2xl:px-[6rem] 2xl:text-[1.5rem] 3xl:h-[6.5rem] 3xl:text-[1.8rem] 3xl:rounded-[4rem] 3xl:px-[7rem] transition-all duration-500 ease-in-out"
                >
                 Our Showrooms
                </Link>
              </div>
