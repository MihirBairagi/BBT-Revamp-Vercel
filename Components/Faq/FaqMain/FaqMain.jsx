                    ...
                    {faq.faqs.map((item, itemIndex) => (
                      <div className=" [&>*:nth-child(1)]:border-t [&>*:nth-child(1)]:border-t-[#ddd]"   key={itemIndex}>
                        ...
                        >
                          ...
                          <AccordionBody >
                            <div className="pr-[2rem] faq-body text-[#010101] text-[1.2rem] [&_li]:my-[0.5rem] [&_ul]:mt-[2rem] md:text-[1.3rem] lg:text-[1.4rem] xl:text-[1.3rem] 1xl:text-[1.4rem] 3xl:text-[1.6rem] xl:pb-[2rem] [&_a]:text-[#2B7CD3] [&_a]:font-[500]" dangerouslySetInnerHTML={{__html:item.answer}}>
