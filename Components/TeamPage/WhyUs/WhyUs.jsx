    ...
    <section>
      <div className="max-[3000px] mx-auto  relative">
        ...
        <div className="hidden sm:block">
          <img
            src="/images/team/why-us-bg.webp"
            alt="Background Image"
            className="w-full object-cover h-[90vh] min-h-[650px]"
          />
        </div>
          ...
          <div className="container w-full h-full">
            ...
            >
              <div className="text-center text-white sm:text-[#111111] sm:text-left">
                ...
                <p className="font-light text-[1.4rem] leading-[1.5] mt-[2rem] sm:mt-[1rem] sm:mb-[1.5rem] lg:text-[1.1rem] lg:tracking-tight xl:text-[1.13rem] xl:leading-[1.5] xl:mb-[3rem] 1xl:text-[1.28rem] 2xl:text-[1.4rem] 2xl:mb-[4.5rem] 3xl:text-[1.6rem] 3xl:leading-[1.5] 3xl:tracking-[0]">
              ...
              <div className="text-center sm:mt-[3rem] sm:text-left 3xl:mt-[5rem]">
                <Link
                  href="/why-us"
                  className="w-full max-w-[31rem] h-[5.5rem] flex justify-center items-center text-[1.4rem] bg-black  text-white px-[3rem] py-[1rem] rounded-[3rem] mx-auto font-medium sm:max-w-[27.3rem] sm:ml-0 xl:h-[4.5rem] xl:max-w-[17rem] xl:text-[1.2rem] 1xl:h-[5rem] 1xl:max-w-[20rem] 1xl:text-[1.4rem] 2xl:max-w-none 2xl:w-max 2xl:px-[6rem] 2xl:text-[1.5rem] 3xl:h-[6.5rem] 3xl:text-[1.8rem] 3xl:rounded-[4rem] 3xl:px-[7rem] hover:bg-[#ffffff] hover:text-black transition-all duration-500 ease-in-out"
                >
                  Why Us?
                </Link>
              </div>
