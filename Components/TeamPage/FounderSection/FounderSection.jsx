            ...
            >
              ...
              <div className="mt-[3rem] xl:pr-[10%] 2xl:mt-[2rem] md:mt-[2rem]">
                <div className="md:flex md:flex-col-reverse">
                  ...
                  <p className="font-light text-[1.4rem] leading-[1.5] mt-[2rem] md:mt-0 lg:text-[1.1rem] lg:tracking-tight xl:text-[1.13rem] xl:leading-[1.5] 1xl:text-[1.28rem] 2xl:text-[1.4rem] 3xl:text-[1.6rem] 3xl:leading-[1.5] 3xl:tracking-[0]">
