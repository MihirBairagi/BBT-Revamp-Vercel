...
const FeaturedItem = ({ data }) => {
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 w-full h-full px-[2rem] py-[2rem] sm:py-[3rem] sm:px-[3rem] xl:px-[3rem] 1xl:py-[5rem] 2xl:pl-[4rem] flex flex-col justify-end 3xl:pb-[7rem] 3xl:pl-[5rem] bg-gradient-to-t from-[rgba(0,0,0,0.9)] to-[rgba(0,0,0,0.05)]">
      ...
      <div className="max-1920">
        <div className="container">
          <div className="flex flex-wrap justify-between items-center">
            <div
              className="w-[48%] md:w-[28.5%] order-2 md:order-1"
              data-aos="fade-up"
              data-aos-easing="linear"
              data-aos-duration="500"
            >
              <FeaturedItem data={data.leftCardData} />
            </div>
            <div
              className="w-full md:w-[32%] text-center order-1 md:order-2"
              data-aos="fade-up"
              data-aos-easing="linear"
              data-aos-duration="500"
            >
              ...
              ></h2>
              <p
                className="font-[300] text-[1.2rem] leading-[1.5] mb-[3rem] lg:text-[1.1rem] lg:tracking-tight xl:text-[1.13rem] xl:leading-[1.5] 1xl:text-[1.28rem] 2xl:text-[1.4rem] 3xl:text-[1.6rem] 3xl:leading-[1.5] 3xl:tracking-[0] [&>b]:font-[500] 3xl:mb-[4rem] [&>br]:hidden lg:[&>br]:block"
            ...
            <div
              className="w-[48%] md:w-[28.5%] order-3"
              data-aos="fade-up"
              data-aos-easing="linear"
              data-aos-duration="500"
            >
              <FeaturedItem data={data.rightCardData} />
            </div>
          </div>
        </div>
      </div>
...
export default InfoWithTwoCard;
